                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="63%" align="left" height="27">
                                                            <asp:DropDownList CssClass="form" ID="Source" runat="server">
                                                                <asp:ListItem Text="Karachi" Value="Karchi"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <div id="txtHint">
                                                                <asp:DropDownList CssClass="form" tyle="width: 130px" ID="Destination" runat="server"
                                                                    ...
                                                                    <asp:ListItem Text="--select--" Value="--select--"></asp:ListItem>
                                                                            ...
                                                                            <asp:ListItem Text="Sukkur" Value="Sukkur"></asp:ListItem>
                                                                            <asp:ListItem Text="Sialkot" Value="Sialkot"></asp:ListItem>
                                                                            <asp:ListItem Text="Bhawalpur" Value="Bhawalpur"></asp:ListItem>
                                                                            <asp:ListItem Text="Quetta" Value="Quetta"></asp:ListItem>
                                                                            <asp:ListItem Text="Multan" Value="Multan"></asp:ListItem>
                                                                            <asp:ListItem Text="Sahiwal" Value="Sahiwal"></asp:ListItem>
                                                                            <asp:ListItem Text="Islamabad" Value="Islamabad"></asp:ListItem>
                                                                            <asp:ListItem Text="Lodhra" Value="Lodhra"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>
